...
const NewsList = Vue.component('news-list',{
	template:`
		<div class="news text-center">
			...
			<h2>News</h2>
			<ul class="news__list">
				<li v-for = "article in articles" class="news__item"><h4>{{ article.title }}</h4><br><img :src = "article.urlToImage" alt ="Article Thumbnail" /><br><p class="news-text">{{ article.description }}</p><br><br></li>
			</ul>
		</div>
